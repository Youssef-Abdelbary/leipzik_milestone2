...
import './componentDock.css';

function DockItem({ children, className = '', onClick, isActive, mouseX, spring, distance, magnification, baseItemSize }) {
  ...
  return (
    ...
    >
      ...
      {isActive && <span className="dock-item__indicator" />}
    </motion.div>
  );
}
