...
//
// Renders as a floating panel — position it with a wrapper (e.g. absolute/fixed).

export default function MiniCalendar({ selectedDates = [], onChange }) {
    const now = new Date();
                    ...
                    return (
                        <button
                            ...
                            style={{
                                ...
                                border: isSelected ? '1px solid rgba(245,179,74,0.5)' : '1px solid transparent',
